...
- Add a CI workflow for running tests, linting, and packaging.
- Add script to create `requirements.txt` from your current environment.
- Add SRT export and improved front-end controls for segment editing.

README created and saved at `README.md`.
